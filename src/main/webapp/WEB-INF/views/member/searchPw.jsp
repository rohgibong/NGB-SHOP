...
<div id="usePhoneForm" style="display:block;">
	...
	<div id="goLogin">
		...
		<a href="${path }/member/searchId" id="searchId">
			아이디 찾기
		</a>
	</div>
...
var errCounter = 0;
	if(document.phoneForm.id.value == ''){
	...
	document.phoneForm.action = "${path}/member/searchPwUsePhone";
...
var errCounter = 0;
	if(document.emailForm.id.value == ''){
		$("#label_id2").html("아이디를 입력해주세요.");
		$("#label_id2").css('color', 'red');
		$("#label_id2").css('font-size', '8px');
		errCounter++;
	} else {
		$("#label_id2").html("");
	}
	...
	document.emailForm.action = "${path}/member/searchPwUseEmail";
